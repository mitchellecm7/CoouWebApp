...
// export default DTS304;

import React, { useState, useEffect } from 'react';
import { View, Text, ActivityIndicator, Alert, StyleSheet, SafeAreaView, StatusBar } from 'react-native';
import ReactNativePDF from 'react-native-pdf';
import RNFetchBlob from 'react-native-blob-util';
import { databases2, databaseId, collectionId, Query, bucketId, projectId2 } from '../../../../src/screens/UploadScreens/config';
import  MaterialIcons  from "react-native-vector-icons/MaterialIcons";

// import { databases2, databaseId, collectionId, Query, bucketId, projectId } from '../../../../../src/screens/UploadScreens/config';
  ...
  useEffect(() => {
    const fetchPdfUri = async () => {
      try {
        ...
        const response = await databases2.listDocuments(databaseId, collectionId, [
        ...
        if (response.documents.length > 0) {
          ...
          const remotePdfUrl = `https://cloud.appwrite.io/v1/storage/buckets/${bucketId}/files/${fileId}/download?project=${projectId2}`;
