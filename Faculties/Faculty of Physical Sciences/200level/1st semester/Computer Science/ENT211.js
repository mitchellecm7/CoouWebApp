...
import { databases1, databaseId, collectionId, Query, bucketId, projectId1 } from '../../../../../src/screens/UploadScreens/config';
  ...
  useEffect(() => {
    const fetchPdfUri = async () => {
      try {
        ...
        const response = await databases1.listDocuments(databaseId, collectionId, [
        ...
        if (response.documents.length > 0) {
          ...
          const remotePdfUrl = `https://cloud.appwrite.io/v1/storage/buckets/${bucketId}/files/${fileId}/download?project=${projectId1}`;
