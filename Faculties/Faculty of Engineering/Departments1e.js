...
const Departments1e = ({ navigation }) => {
  ...
  const filteredDepartments = departments.filter(department => department.id > 5 && department.id < 6);
  ...
  //   let targetScreen = '';
  //   if (selectedDepartment === 'Department of CHEMICAL ENGINEERING') {
  //     if (selectedLevel === '100 level' && semester === '1st semester') {
  //       targetScreen = 'ChemicalEngineering1001';
  //     } else if (selectedLevel === '100 level' && semester === '2nd semester') {
  //       targetScreen = 'ChemicalEngineering1002';
  //     } else if (selectedLevel === '200 level' && semester === '1st semester') {
  //       targetScreen = 'ChemicalEngineering2001';
  //     } 
  //     else if (selectedLevel === '200 level' && semester === '2nd semester') {
  //       targetScreen = 'ChemicalEngineering2002';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '1st semester') {
  //       targetScreen = 'ChemicalEngineering3001';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '2nd semester') {
  //       targetScreen = 'ChemicalEngineering3002';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '1st semester') {
  //       targetScreen = 'ChemicalEngineering4001';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '2nd semester') {
  //       targetScreen = 'ChemicalEngineering4002';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '1st semester') {
  //       targetScreen = 'ChemicalEngineering5001';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '2nd semester') {
  //       targetScreen = 'ChemicalEngineering5002';
  //     }
  //     //I will Add more conditions for other levels and semesters
  //   } 
  //   else if (selectedDepartment === 'Department of CIVIL ENGINEERING') {
  //     if (selectedLevel === '100 level' && semester === '1st semester') {
  //       targetScreen = 'CivilEngineering1001';
  //     } else if (selectedLevel === '100 level' && semester === '2nd semester') {
  //       targetScreen = 'CivilEngineering1002';
  //     } else if (selectedLevel === '200 level' && semester === '1st semester') {
  //       targetScreen = 'CivilEngineering2001';
  //     } 
  //     else if (selectedLevel === '200 level' && semester === '2nd semester') {
  //       targetScreen = 'CivilEngineering2002';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '1st semester') {
  //       targetScreen = 'CivilEngineering3001';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '2nd semester') {
  //       targetScreen = 'CivilEngineering3002';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '1st semester') {
  //       targetScreen = 'CivilEngineering4001';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '2nd semester') {
  //       targetScreen = 'CivilEngineering4002';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '1st semester') {
  //       targetScreen = 'CivilEngineering5001';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '2nd semester') {
  //       targetScreen = 'CivilEngineering5002';
  //     }
  //     //I will Add more conditions for other levels and semesters
  //   }
  //   else if (selectedDepartment === 'Department of ELECTRICAL/ ELECTRONIC ENGINEERING') {
  //     if (selectedLevel === '100 level' && semester === '1st semester') {
  //       targetScreen = 'Electrical/ElectronicEngineering1001';
  //     } else if (selectedLevel === '100 level' && semester === '2nd semester') {
  //       targetScreen = 'Electrical/ElectronicEngineering1002';
  //     } else if (selectedLevel === '200 level' && semester === '1st semester') {
  //       targetScreen = 'Electrical/ElectronicEngineering2001';
  //     } 
  //     else if (selectedLevel === '200 level' && semester === '2nd semester') {
  //       targetScreen = 'Electrical/ElectronicEngineering2002';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '1st semester') {
  //       targetScreen = 'Electrical/ElectronicEngineering3001';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '2nd semester') {
  //       targetScreen = 'Electrical/ElectronicEngineering3002';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '1st semester') {
  //       targetScreen = 'Electrical/ElectronicEngineering4001';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '2nd semester') {
  //       targetScreen = 'Electrical/ElectronicEngineering4002';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '1st semester') {
  //       targetScreen = 'Electrical/ElectronicEngineering5001';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '2nd semester') {
  //       targetScreen = 'Electrical/ElectronicEngineering5002';
  //     }
  //     //I will Add more conditions for other levels and semesters
  //   }
  //   else if (selectedDepartment === 'Department of MECHANICAL ENGINEERING') {
  //     if (selectedLevel === '100 level' && semester === '1st semester') {
  //       targetScreen = 'MechanicalEngineering1001';
  //     } else if (selectedLevel === '100 level' && semester === '2nd semester') {
  //       targetScreen = 'MechanicalEngineering1002';
  //     } else if (selectedLevel === '200 level' && semester === '1st semester') {
  //       targetScreen = 'MechanicalEngineering2001';
  //     } 
  //     else if (selectedLevel === '200 level' && semester === '2nd semester') {
  //       targetScreen = 'MechanicalEngineering2002';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '1st semester') {
  //       targetScreen = 'MechanicalEngineering3001';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '2nd semester') {
  //       targetScreen = 'MechanicalEngineering3002';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '1st semester') {
  //       targetScreen = 'MechanicalEngineering4001';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '2nd semester') {
  //       targetScreen = 'MechanicalEngineering4002';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '1st semester') {
  //       targetScreen = 'MechanicalEngineering5001';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '2nd semester') {
  //       targetScreen = 'MechanicalEngineering5002';
  //     }
  //     //I will Add more conditions for other levels and semesters
  //   }
  //   if (targetScreen) {
