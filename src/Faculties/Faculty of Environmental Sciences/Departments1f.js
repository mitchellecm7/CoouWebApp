...
const Departments1f = ({ navigation }) => {
  ...
  const filteredDepartments = departments.filter(department => department.id > 6 && department.id < 7);
  ...
  //   let targetScreen = '';
  //   if (selectedDepartment === 'Department of ARCHITECTURE') {
  //     if (selectedLevel === '100 level' && semester === '1st semester') {
  //       targetScreen = 'Architecture1001';
  //     } else if (selectedLevel === '100 level' && semester === '2nd semester') {
  //       targetScreen = 'Architecture1002';
  //     } else if (selectedLevel === '200 level' && semester === '1st semester') {
  //       targetScreen = 'Architecture2001';
  //     } 
  //     else if (selectedLevel === '200 level' && semester === '2nd semester') {
  //       targetScreen = 'Architecture2002';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '1st semester') {
  //       targetScreen = 'Architecture3001';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '2nd semester') {
  //       targetScreen = 'Architecture3002';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '1st semester') {
  //       targetScreen = 'Architecture4001';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '2nd semester') {
  //       targetScreen = 'Architecture4002';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '1st semester') {
  //       targetScreen = 'Architecture5001';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '2nd semester') {
  //       targetScreen = 'Architecture5002';
  //     }
  //     //I will Add more conditions for other levels and semesters
  //   } 
  //   else if (selectedDepartment === 'Department of ESTATE MANAGEMENT') {
  //     if (selectedLevel === '100 level' && semester === '1st semester') {
  //       targetScreen = 'EstateManagement1001';
  //     } else if (selectedLevel === '100 level' && semester === '2nd semester') {
  //       targetScreen = 'EstateManagement1002';
  //     } else if (selectedLevel === '200 level' && semester === '1st semester') {
  //       targetScreen = 'EstateManagement2001';
  //     } 
  //     else if (selectedLevel === '200 level' && semester === '2nd semester') {
  //       targetScreen = 'EstateManagement2002';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '1st semester') {
  //       targetScreen = 'EstateManagement3001';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '2nd semester') {
  //       targetScreen = 'EstateManagement3002';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '1st semester') {
  //       targetScreen = 'EstateManagement4001';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '2nd semester') {
  //       targetScreen = 'EstateManagement4002';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '1st semester') {
  //       targetScreen = 'EstateManagement5001';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '2nd semester') {
  //       targetScreen = 'EstateManagement5002';
  //     }
  //     //I will Add more conditions for other levels and semesters
  //   }
  //   else if (selectedDepartment === 'Department of ENVIRONMENTAL MANAGEMENT') {
  //     if (selectedLevel === '100 level' && semester === '1st semester') {
  //       targetScreen = 'EnvironmentalManagement1001';
  //     } else if (selectedLevel === '100 level' && semester === '2nd semester') {
  //       targetScreen = 'EnvironmentalManagement1002';
  //     } else if (selectedLevel === '200 level' && semester === '1st semester') {
  //       targetScreen = 'EnvironmentalManagement2001';
  //     } 
  //     else if (selectedLevel === '200 level' && semester === '2nd semester') {
  //       targetScreen = 'EnvironmentalManagement2002';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '1st semester') {
  //       targetScreen = 'EnvironmentalManagement3001';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '2nd semester') {
  //       targetScreen = 'EnvironmentalManagement3002';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '1st semester') {
  //       targetScreen = 'EnvironmentalManagement4001';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '2nd semester') {
  //       targetScreen = 'EnvironmentalManagement4002';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '1st semester') {
  //       targetScreen = 'EnvironmentalManagement5001';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '2nd semester') {
  //       targetScreen = 'EnvironmentalManagement5002';
  //     }
  //     //I will Add more conditions for other levels and semesters
  //   }
  //   else if (selectedDepartment === 'Department of URBAN AND REGIONAL PLANNING') {
  //     if (selectedLevel === '100 level' && semester === '1st semester') {
  //       targetScreen = 'Urban&RegionalPlanning1001';
  //     } else if (selectedLevel === '100 level' && semester === '2nd semester') {
  //       targetScreen = 'Urban&RegionalPlanning1002';
  //     } else if (selectedLevel === '200 level' && semester === '1st semester') {
  //       targetScreen = 'Urban&RegionalPlanning2001';
  //     } 
  //     else if (selectedLevel === '200 level' && semester === '2nd semester') {
  //       targetScreen = 'Urban&RegionalPlanning2002';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '1st semester') {
  //       targetScreen = 'Urban&RegionalPlanning3001';
  //     }
  //     else if (selectedLevel === '300 level' && semester === '2nd semester') {
  //       targetScreen = 'Urban&RegionalPlanning3002';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '1st semester') {
  //       targetScreen = 'Urban&RegionalPlanning4001';
  //     }
  //     else if (selectedLevel === '400 level' && semester === '2nd semester') {
  //       targetScreen = 'Urban&RegionalPlanning4002';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '1st semester') {
  //       targetScreen = 'Urban&RegionalPlanning5001';
  //     }
  //     else if (selectedLevel === '500 level' && semester === '2nd semester') {
  //       targetScreen = 'Urban&RegionalPlanning5002';
  //     }
  //     //I will Add more conditions for other levels and semesters
  //   }
  //   if (targetScreen) {
