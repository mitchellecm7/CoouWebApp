...
const GEY206 = ({ title = "GEY206 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for GEY206 course');
        }
      } catch (err) {
