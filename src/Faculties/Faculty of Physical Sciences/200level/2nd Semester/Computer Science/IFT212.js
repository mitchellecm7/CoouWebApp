...
const IFT212 = ({ title = "IFT212 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for IFT212 course');
        }
      } catch (err) {
