...
const COS262 = ({ title = "COS262 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for COS262 course');
        }
      } catch (err) {
