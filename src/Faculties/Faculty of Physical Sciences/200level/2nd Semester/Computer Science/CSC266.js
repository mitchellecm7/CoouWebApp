...
const CSC266 = ({ title = "CSC266 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC266 course');
        }
      } catch (err) {
