...
const CSC299 = ({ title = "CSC299 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC299 course');
        }
      } catch (err) {
