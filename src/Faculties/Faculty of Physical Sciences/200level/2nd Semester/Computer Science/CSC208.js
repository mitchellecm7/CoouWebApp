...
const CSC208 = ({ title = "CSC208 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC208 course');
        }
      } catch (err) {
