...
const CSC221 = ({ title = "CSC221 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC221 course');
        }
      } catch (err) {
