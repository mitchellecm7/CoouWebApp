...
const COS261 = ({ title = "COS261 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for COS261 course');
        }
      } catch (err) {
