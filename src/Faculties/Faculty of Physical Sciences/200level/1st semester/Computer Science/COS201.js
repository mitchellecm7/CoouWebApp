...
const COS201 = ({ title = "COS201 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for COS201 course');
        }
      } catch (err) {
