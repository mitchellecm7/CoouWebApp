...
const CSC267 = ({ title = "CSC267 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC267 course');
        }
      } catch (err) {
