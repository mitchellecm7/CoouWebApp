...
const CSC441 = ({ title = "CSC441 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC441 course');
        }
      } catch (err) {
