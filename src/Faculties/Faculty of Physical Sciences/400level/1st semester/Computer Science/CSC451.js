...
const CSC451 = ({ title = "CSC451 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC451 course');
        }
      } catch (err) {
