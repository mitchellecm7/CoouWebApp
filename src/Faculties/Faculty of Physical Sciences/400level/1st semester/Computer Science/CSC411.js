...
const CSC411 = ({ title = "CSC411 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC411 course');
        }
      } catch (err) {
