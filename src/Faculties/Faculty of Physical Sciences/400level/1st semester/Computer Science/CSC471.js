...
const CSC471 = ({ title = "CSC471 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC471 course');
        }
      } catch (err) {
