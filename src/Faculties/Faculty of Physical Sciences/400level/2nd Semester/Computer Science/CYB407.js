...
const CYB407 = ({ title = "CYB407 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CYB407 course');
        }
      } catch (err) {
