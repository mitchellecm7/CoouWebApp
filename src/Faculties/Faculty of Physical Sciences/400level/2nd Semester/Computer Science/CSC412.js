...
const CSC412 = ({ title = "CSC412 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC412 course');
        }
      } catch (err) {
