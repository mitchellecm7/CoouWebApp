...
const CSC454 = ({ title = "CSC454 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC454 course');
        }
      } catch (err) {
