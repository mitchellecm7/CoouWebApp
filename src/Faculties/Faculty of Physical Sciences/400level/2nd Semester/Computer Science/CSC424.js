...
const CSC424 = ({ title = "CSC424 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC424 course');
        }
      } catch (err) {
