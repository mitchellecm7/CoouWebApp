...
const CSC426 = ({ title = "CSC426 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC426 course');
        }
      } catch (err) {
