...
import { collectionId, databaseId, databases2, Query } from '../../../../../screens/UploadScreens/config';
...
const Cis3001 = () => {
  ...
  const styles = {
      ...
      coursesContainer: {
        maxHeight: 'calc(100vh - 150px)', // Takes most of the viewport height
    ...
    return (
      <div style={styles.cisContainer}>
        <div style={styles.headerContainer}>
          ...
          <h1 style={styles.cisHeader}>300 Level <br/> 1st Semester Courses</h1>
        </div>
