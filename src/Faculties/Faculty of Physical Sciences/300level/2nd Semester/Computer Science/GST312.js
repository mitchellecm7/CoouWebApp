...
const GST312 = ({ title = "GST312 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for GST312 course');
        }
      } catch (err) {
