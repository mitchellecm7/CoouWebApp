...
const ENT312 = ({ title = "ENT312 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for ENT312 course');
        }
      } catch (err) {
