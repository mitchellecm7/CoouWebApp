...
const DTS304 = ({ title = "DTS304 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for DTS304 course');
        }
      } catch (err) {
