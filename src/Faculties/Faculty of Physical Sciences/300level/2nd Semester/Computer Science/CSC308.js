...
const CSC308 = ({ title = "CSC308 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC308 course');
        }
      } catch (err) {
