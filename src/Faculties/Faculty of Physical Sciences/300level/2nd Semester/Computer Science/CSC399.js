...
const CSC399 = ({ title = "CSC399 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC399 course');
        }
      } catch (err) {
