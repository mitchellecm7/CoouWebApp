...
const CSC105 = ({ title = "CSC105 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for CSC105 course');
        }
      } catch (err) {
