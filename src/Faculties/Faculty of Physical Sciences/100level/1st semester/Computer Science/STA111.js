...
const STA111 = ({ title = "STA111 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for STA111 course');
        }
      } catch (err) {
