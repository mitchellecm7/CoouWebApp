...
const MTH101 = ({ title = "MTH101 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for MTH101 course');
        }
      } catch (err) {
