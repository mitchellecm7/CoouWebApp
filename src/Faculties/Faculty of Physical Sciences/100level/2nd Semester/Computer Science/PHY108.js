...
const PHY108 = ({ title = "PHY108 - Introduction to Computer Science"}) => {
    ...
    const fetchPdf = async () => {
      try {
        ...
        if (response.documents.length > 0) {
          ...
          setError('No PDF found for PHY108 course');
        }
      } catch (err) {
